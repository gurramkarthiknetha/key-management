...
const SecurityHeadDashboard = () => {
  ...
  const keyStatusData = [
    { name: 'In Use', value: mockAnalytics.issuedKeys },
    { name: 'Available', value: mockAnalytics.availableKeys },
    { name: 'Overdue', value: mockAnalytics.overdueKeys },
    { name: 'Lost', value: mockAnalytics.lostKeys },
    { name: 'Damaged', value: mockAnalytics.damagedKeys },
    { name: 'Maintenance', value: mockAnalytics.maintenanceKeys },
  ];
          ...
          <Card padding="md">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{mockAnalytics.issuedKeys}</p>
              </div>
            </div>
          </Card>
          ...
          <Card padding="md">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{mockAnalytics.availableKeys}</p>
              </div>
            </div>
          </Card>
          ...
          {activeTab === 'analytics' && (
            <>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <AnalyticsChart
                  type="line"
                  data={mockAnalytics.monthlyStats.map(stat => ({
                    date: stat.month,
                    checkouts: stat.issued,
                    checkins: stat.returned
                  }))}
              ...
              <AnalyticsChart
                type="bar"
                data={mockAnalytics.departmentStats.map(dept => ({
                  department: dept.department,
                  usage: dept.keysIssued
                }))}
